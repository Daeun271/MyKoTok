...
class ReformerTrainer(object):
    def __init__(self,
                 ...
                 tb_writer=False,
                 tb_dir='wp_reformer/tb_logs',
                 log_dir='wp_reformer/logs'):
...
def main():
    ...
    config = ModelConfig(config_path='wp_reformer/config/mlm-pretrain-small.json').get_config()
    ...
    model = ReformerLM(
        ...
        causal=False # True for autoregressive language modeling
    )
